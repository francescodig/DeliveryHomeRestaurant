...
public void addAddress(HttpServletRequest request, HttpServletResponse response, String[] params)
    ...
    try {
        ...
        String civico = InputSanitizer.sanitize(request.getParameter("civico"));
...
public void removeAccount(HttpServletRequest request, HttpServletResponse response, String[] params) throws IOException{
    ...
    try{
        ...
        response.sendRedirect(request.getContextPath() + "/User/logoutUser");
                ...
                UtilFlashMessages.addMessage(request, "error", "Errore nell'eliminazione dell'account!");
                response.sendRedirect(request.getContextPath() + "/User/showProfile");
